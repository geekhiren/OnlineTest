...
namespace TestDemo.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "QuestionID,QuestionText,TestID")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "QuestionID,QuestionText,TestID")] Question question)
        {
            if (ModelState.IsValid)
            {
